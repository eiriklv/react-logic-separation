...
import { CategorySidebarViewModelContext } from "./CategorySidebar.viewmodel.context";
...
export type CategorySidebarViewModelProps = {
  selectedCategoryModel: SelectedCategoryModel;
};

export const useCategorySidebarViewModel = ({
  selectedCategoryModel,
}: CategorySidebarViewModelProps) => {
  const { remindersModel } = useContext(CategorySidebarViewModelContext);

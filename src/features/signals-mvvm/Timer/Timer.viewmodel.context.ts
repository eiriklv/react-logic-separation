...
export interface TimerViewModelContextInterface {
  timerModel: typeof timerModel;
}

export const defaultValue: TimerViewModelContextInterface = {
  timerModel,
};

export const TimerViewModelContext =
  React.createContext<TimerViewModelContextInterface>(defaultValue);

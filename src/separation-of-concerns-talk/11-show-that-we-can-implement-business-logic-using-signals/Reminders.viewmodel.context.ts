...
export interface RemindersViewModelContextInterface {
  remindersModel: typeof remindersModel;
}

export const defaultValue: RemindersViewModelContextInterface = {
  remindersModel,
};

export const RemindersViewModelContext =
  React.createContext<RemindersViewModelContextInterface>(defaultValue);
